...
const TRACK2 = preload("res://assets/music/more options/488362__soundflakes__dark-dramatic-atmospheric-soundscape.ogg")
const TRACK3 = preload("res://assets/music/more options/524309__bertsz__dark-cyberpunk-orchestral-music.ogg")
const TRACK4 = preload("res://assets/music/more options/525290__disquantic__cyberpunk-beat.ogg")
const TRACK5 = preload("res://assets/music/more options/611305__szegvari__new-york-cyberpunk-synth-analogue-drums-bass-dance-retro-atmo-ambience-pad-drone-cinematic-action-music-surround.ogg")
