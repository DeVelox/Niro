...
var groups: int = 3
var speed_variant_array: Array[int] = [0,80,50,-20]
var shape: String = "half_circle"
var barrage_wait_time: float = 0.15
var mode: String = "shotgun"
var bullet_spread: int = 5
